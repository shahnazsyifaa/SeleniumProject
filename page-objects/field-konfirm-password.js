module.exports = {
    ...
    elements: {
        fieldKonfirmPassword: by.xpath("//*[@id='inputPassword2']")
    },
    ...
    performFill: function () {
        ...
        var selector = page.fieldKonfirmPassword.elements.fieldKonfirmPassword
        ...
        return driver.findElement(selector).sendKeys(shared.akun1[9].konfirmPassword);
    }
};