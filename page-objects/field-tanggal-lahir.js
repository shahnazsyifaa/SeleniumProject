module.exports = {
    ...
    elements: {
        fieldTanggalLahir: by.xpath("//*[@id='inputTglahir']")
    },
    ...
    performFill: function () {
        ...
        var selector = page.fieldTanggalLahir.elements.fieldTanggalLahir
        ...
        return driver.findElement(selector).sendKeys(shared.akun1[9].tanggalLahir);
    }
};